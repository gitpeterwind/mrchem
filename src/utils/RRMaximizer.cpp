...
RRMaximizer::RRMaximizer(double prec, OrbitalVector &Phi) {
    ...
    R_x = orbital::calc_overlap_matrix_task(Phi, xPhi_Vec, 1);
    R_y = orbital::calc_overlap_matrix_task(Phi, yPhi_Vec, 1);
    R_z = orbital::calc_overlap_matrix_task(Phi, zPhi_Vec, 1);
