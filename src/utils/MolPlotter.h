...
public:
    ...
    void linePlot(const std::array<int, 1> &npts, mrcpp::CplxFunc &func, const std::string &fname) {
        if (func.hasReal()) linePlot(npts, func.real(), fname + "_re");
        if (func.hasImag()) linePlot(npts, func.imag(), fname + "_im");
    }
    void surfPlot(const std::array<int, 2> &npts, mrcpp::CplxFunc &func, const std::string &fname) {
        if (func.hasReal()) surfPlot(npts, func.real(), fname + "_re");
        if (func.hasImag()) surfPlot(npts, func.imag(), fname + "_im");
    }
    void cubePlot(const std::array<int, 3> &npts, mrcpp::CplxFunc &func, const std::string &fname) {
